...
| 11 | Active first physical-device qualification; no physical install yet | [Baseline](PHASE_11_BASELINE.md) · [ADR](decisions/0028-phase-11-physical-qualification.md) |
